...
import circleland.Attacks.BoomerangAttack;
 ...
 * @author Jeff
 */
public class BoomerangWeapon extends CircleWeapon{
    public static final Color CENTER_COLOR = Color.ORANGE; //item type color
    ...
    public void attack(CircleEntity owner, ArrayList<CircleAttack> attacks)
    {
        ...
        BoomerangAttack bA = new BoomerangAttack(owner,attackLife,owner.attackDamage(),
