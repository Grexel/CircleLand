...
import circleland.Attacks.FlameAttack;
import circleland.Attacks.NovaAttack;
 ...
 * @author Jeff
 */
public class NovaWeapon extends CircleWeapon{
    public static final Color CENTER_COLOR = Color.CYAN; //item type color
    ...
    public static final int BASE_ATTACKDAMAGE_BONUS = 0;
    ...
    public static final int BASE_ATTACKSPEED_BONUS = 400;
    public static final int BASE_CASTSPEED_BONUS = 0;
    public static final int BASE_MOVESPEED_BONUS = 20;
    public static final int BASE_BULLET_SIZE = 150;
    ...
    public void attack(CircleEntity owner, ArrayList<CircleAttack> attacks)
    {
        ...
        NovaAttack bA = new NovaAttack(owner,(int)owner.attackSpeed(),owner.attackDamage(),
