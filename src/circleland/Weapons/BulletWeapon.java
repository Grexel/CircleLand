 ...
 * @author Jeff
 */
public class BulletWeapon extends CircleWeapon {
    public static final Color CENTER_COLOR = Color.GRAY; //item type color
    public static final int BASE_ATTACK_MOVESPEED = 180;
    ...
    public void attack(CircleEntity owner, ArrayList<CircleAttack> attacks)
    {
        ...
        BulletAttack bA = new BulletAttack(owner,attackLife,owner.attackDamage(),
