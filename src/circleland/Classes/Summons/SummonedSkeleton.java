 ...
 * @author Jeff
 */
public class SummonedSkeleton extends CircleSummoned{
    ...
    public SummonedSkeleton(int level)
    {
        super();
        name = "Skeleton";
        size = 25;
    ...
    public SummonedSkeleton(int x, int y)
    {
        super();
        name = "Skeleton";
        size = 25;
                    ...
                    for(CircleEntity cE : world.monsters()) {
                        if(cE.intersectsCircle(position, viewRadius))
                        {
                            if(closestEntity != null){
                                double distcE = distanceBetweenPoints(this.position(), cE.position());
                                double distClosest = distanceBetweenPoints(this.position(), closestEntity.position());
                                if(distcE < distClosest)
                                    closestEntity = cE;
                            }   
